package com.ltakacs.first.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.ltakacs.first.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.ltakacs.first.repository.UserRepository.USERS_BY_EMAIL_CACHE);
